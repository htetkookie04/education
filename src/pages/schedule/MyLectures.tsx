          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="whitespace-nowrap text-center text-lg">수업 상태</TableHead>
                <TableHead className="whitespace-nowrap text-center text-lg">교육명</TableHead>
                <TableHead className="whitespace-nowrap text-center text-lg">교육기관</TableHead>
                <TableHead className="whitespace-nowrap text-center text-lg">수업 차시</TableHead>
                <TableHead className="whitespace-nowrap text-center text-lg">일자</TableHead>
                <TableHead className="whitespace-nowrap text-center text-lg">시작 시간</TableHead>
